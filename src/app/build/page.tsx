              ...
              <section>
                ...
                {workFields.map((field, index) => (
                  <div key={field.id} className="p-4 border rounded-md relative mb-4 space-y-4">
                     ...
                     <FormField control={form.control} name={`workExperience.${index}.dates`} render={({ field }) => ( <FormItem><FormLabel>Dates (e.g., May 2020 - Present)</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormMessage> )} />
